...
document.addEventListener('DOMContentLoaded', () => {
    const searchInput = document.getElementById('bungieName') as HTMLInputElement;
    ...
    async function handleSearch(event: Event) {
        ...
        if (bungieName) {
            ...
            if (response.ok) {
                ...
                url.searchParams.set('playerNamesAndMembership', encodeURIComponent(JSON.stringify(playerNamesAndMembership)));
