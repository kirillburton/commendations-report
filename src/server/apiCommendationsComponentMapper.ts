        ...
        commendations: [
            {
                hash: '3872064891',
                text: 'Perceptive',
                weight: { ...defaultWeight, raidsAndDungeons: true }
            },
            {
                hash: '3970150545',
                text: 'Knowledgeable',
        ...
        commendations: [
            {
                hash: '4209356036',
                text: 'Playmaker',
                weight: { ...defaultWeight, crucible: true }
            },
            {
                hash: '363818544',
                text: 'Primeval Instinct',
                weight: { ...defaultWeight, gambit: true }
            },
            {
                hash: '3575743922',
                text: 'Heroic',
        ...
        commendations: [
            {
                hash: '2019871317',
                text: 'Indispensable',
                weight: { ...defaultWeight, endgamePve: true }
            },
            {
                hash: '354527503',
                text: 'Selfless',
            ...
            },
            {
                hash: '3513056018',
                text: 'Thoughtful',
                weight: { ...defaultWeight, casualPve: true }
            },
            {
                hash: '2506835299',
                text: 'Patient and Considerate',
                weight: { ...defaultWeight, raidsAndDungeons: true }
            }
        ]
    },
    {
        ...
        commendations: [
            ...
            },
            {
                hash: '3037314846',
                text: 'Level-headed',
                weight: { ...defaultWeight, crucible: true, gambit: true }
            },
            {
                hash: '3030493827',
...
function getPlayerCommendationsCardInText(
    summary: CommendationSummary
): string {
...
function mapCommendationsResponse(
    input: CommendationsComponentResponse
): CommendationSummary {
    ...
    const categories: CommendationCategory[] = commendationCategories.map(
        (category) => {
            const commendations: Commendation[] = category.commendations
                .map((commendation) => {
                    const score =
                        data.commendationScoresByHash[commendation.hash];
                    if (score > 0) {
                        for (const [key, value] of Object.entries(
                            ...
                            if (value) {
                                activityPoints[
                                    key as keyof ProfileActivitiesWeight
                                ] += score;
                            }
                        }
